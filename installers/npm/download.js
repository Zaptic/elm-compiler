...
module.exports = function (callback) {
  ...
  var binaryPath =
    path.resolve(__dirname, package.bin.elm) +
...
function verifyPlatform(version, platform) {
  ...
  console.error(
    "-- ERROR -----------------------------------------------------------------------\n\n" +
      "I am detecting that your computer (" +
      situation +
      ") may not be compatible with any\n" +
      "of the official pre-built binaries.\n\n" +
      "I recommend against using the npm installer for your situation. Check out the\n" +
      "alternative installers at https://github.com/elm/compiler/releases/tag/" +
      version +
      "\n" +
